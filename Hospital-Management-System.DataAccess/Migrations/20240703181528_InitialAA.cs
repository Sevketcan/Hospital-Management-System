    ...
    public partial class InitialAA : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Main Street 2", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, "jane.smith@example.com", "Jane", "password", "987654321", "Smith", "12345678901", "janesmith" });

            migrationBuilder.InsertData(
                table: "Hospitals",
                columns: new[] { "Id", "AdminId", "Adress", "CreatedDate", "IsDeleted", "Name", "PhoneNumber" },
                values: new object[] { 1, 1, "Main Street 1", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, "Central Hospital", "123456789" });

            migrationBuilder.InsertData(
                table: "Doctors",
                columns: new[] { "Id", "BranchName", "HospitalId", "Name", "Password", "PhoneNumber", "Surname", "Username" },
                values: new object[] { 1, "Cardiology", 1, "John", "password", "123456789", "Doe", "johndoe" });

            migrationBuilder.InsertData(
                table: "Appointments",
                columns: new[] { "Id", "CreatedDate", "DateTime", "DoctorId", "IsDeleted", "PatientId" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 1, 1, 10, 0, 0, 0, DateTimeKind.Unspecified), 1, false, 1 });

            migrationBuilder.InsertData(
                table: "Prescriptions",
                columns: new[] { "Id", "CreatedDate", "DoctorId", "IsDeleted", "MedicationName", "PatientId", "PrescriptionDate", "Usage" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, false, "Aspirin", 1, new DateOnly(2023, 1, 1), "Twice a day" });
