	...
	public class HospitalDbContext : IdentityDbContext<AppUser, AppRole, int>
	{
		...
		protected override void OnModelCreating(ModelBuilder builder)
		{
			...
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 1, Name = "Sevket Can", Surname = "Kalyancioglu", BranchName = "Urolog", PhoneNumber = "123456789", Username = "onlysevk", Password = "kalyancisevket", HospitalId = 1 }
			);
			builder.Entity<Doctor>().HasData(
			...
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 3, Name = "Esmer", Surname = "HASANOVA", BranchName = "Kadin Hastaliklari ve Dogum", PhoneNumber = "456123789", Username = "smerhasan", Password = "hasanesmr", HospitalId = 1 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 4, Name = "Sinem", Surname = "AKAY", BranchName = "Beyin Cerrahisi", PhoneNumber = "127834569", Username = "aksikinem", Password = "rivakkayariv", HospitalId = 1 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 5, Name = "Faruk", Surname = "TUFEKCI", BranchName = "Psikiyatri", PhoneNumber = "561278349", Username = "hellokityfaruk", Password = "faruk3131", HospitalId = 1 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 6, Name = "Museyip", Surname = "HAKKO", BranchName = "Iç Hastaliklari Uzmani", PhoneNumber = "527613849", Username = "museyipp", Password = "muss03169", HospitalId = 2 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 7, Name = "Osman", Surname = "Ozkeles", BranchName = "KBB Hastaliklari Uzmani", PhoneNumber = "561382749", Username = "usmankeles", Password = "613127", HospitalId = 2 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 8, Name = "Cezmi", Surname = "Tuncer", BranchName = "Cocuk Sagligi Ve Hastaliklari Uzmani", PhoneNumber = "527496138", Username = "tuncercezmi", Password = "8521613", HospitalId = 2 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 9, Name = "Zerrin", Surname = "Goksin", BranchName = "Goz Sagligi ve Hastaliklari Uzmani", PhoneNumber = "561749382", Username = "gokzerrin", Password = "631271", HospitalId = 2 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 10, Name = "Leyla", Surname = "Sonmez", BranchName = "Klinik Psikolog", PhoneNumber = "527461389", Username = "sonmezreis", Password = "131267", HospitalId = 2 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 11, Name = "Denizmen", Surname = "Aygün", BranchName = "Cocuk Sagligi ve Hastaliklari Uzmani", PhoneNumber = "527461389", Username = "sonmezreis", Password = "131267", HospitalId = 3 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 12, Name = "Altay", Surname = "Iskender", BranchName = "Anestezi ve Reanimasyon", PhoneNumber = "574612389", Username = "sikender", Password = "112367", HospitalId = 3 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 13, Name = "Alaattin", Surname = "Ersoy", BranchName = "Cocuk Sagligi ve Hastaliklari", PhoneNumber = "523874619", Username = "ersoyyy", Password = "167312", HospitalId = 3 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 14, Name = "Aleyna", Surname = "Ergul", BranchName = "Beslenme ve Diyet", PhoneNumber = "538274619", Username = "ergulaleyna", Password = "213167", HospitalId = 3 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 15, Name = "Ali", Surname = "Kadayifci", BranchName = "Urolog", PhoneNumber = "513827469", Username = "alikadayifci", Password = "261317", HospitalId = 3 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 16, Name = "Emre", Surname = "YILDIRIM", BranchName = "Gastroenteroloji", PhoneNumber = "518274369", Username = "emreyildirim", Password = "261731", HospitalId = 4 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 17, Name = "Abdullah", Surname = "OZKAYA", BranchName = "Goz Hastaliklari", PhoneNumber = "582137469", Username = "abdullahockaya", Password = "231617", HospitalId = 4 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 18, Name = "Abdulmuttalip", Surname = "SIMSEK", BranchName = "Urolog", PhoneNumber = "382751469", Username = "abulsimsek", Password = "276131", HospitalId = 4 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 19, Name = "Abdurrahman", Surname = "ONEN", BranchName = "Boys Urolog", PhoneNumber = "274695138", Username = "onenabd", Password = "261371", HospitalId = 4 }
			);
			builder.Entity<Doctor>().HasData(
			...
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 21, Name = "Mete Oguz", Surname = "Ekinci", BranchName = "Urolog", PhoneNumber = "138274659", Username = "meteoguz", Password = "271361", HospitalId = 5 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 22, Name = "Ekrem", Surname = "Aytac", BranchName = "Kulak Burun Bogaz Hastaliklar", PhoneNumber = "513898927469", Username = "ekerrmm", Password = "26117", HospitalId = 5 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 23, Name = "Ozer", Surname = "Celik", BranchName = "Genel Cerrahi", PhoneNumber = "51386527469", Username = "ozercelik", Password = "456875", HospitalId = 5 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 24, Name = "Bahri", Surname = "Muftuoglu", BranchName = "Goz Sagligi ve Hastaliklari", PhoneNumber = "51382437469", Username = "bahri", Password = "26178317", HospitalId = 5 }
			);
			builder.Entity<Doctor>().HasData(
				new Doctor { Id = 25, Name = "Mehmet", Surname = "Beyli", BranchName = "Acil Servis", PhoneNumber = "51382712469", Username = "memetbeyli", Password = "26212341317", HospitalId = 5 }
			);
